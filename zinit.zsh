...
# blox theme
zinit ice silent src'blox.zsh'
zinit light yardnsm/blox-zsh-theme
...
zinit ice silent svn wait '1a' multisrc'*.zsh' pick'/dev/null'
zinit snippet OMZ::lib

# alias提示插件
zinit ice silent wait'1b'
zinit light djui/alias-tips

# 自动括号, 引号匹配插件
zinit ice silent wait'1c'
...
# 大量常用命令的补全插件
zinit ice silent blockf wait'3c'
